...
public class QueryTwinDeviceThingsRunner extends QueryTwinTests
{
    static Collection<BaseDevice> identities;



    public QueryTwinDeviceThingsRunner(String deviceId, String moduleId, IotHubClientProtocol protocol, AuthenticationType authenticationType, ClientType clientType, String publicKeyCert, String privateKey, String x509Thumbprint)
    {
