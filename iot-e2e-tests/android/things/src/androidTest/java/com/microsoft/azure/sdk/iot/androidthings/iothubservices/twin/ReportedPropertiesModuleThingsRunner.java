...
public class ReportedPropertiesModuleThingsRunner extends ReportedPropertiesTests
{
    static Collection<BaseDevice> identities;



    public ReportedPropertiesModuleThingsRunner(String deviceId, String moduleId, IotHubClientProtocol protocol, AuthenticationType authenticationType, ClientType clientType, String publicKeyCert, String privateKey, String x509Thumbprint)
    {
