...
public class GetTwinDeviceThingsRunner extends GetTwinTests
{
    static Collection<BaseDevice> identities;



    public GetTwinDeviceThingsRunner(String deviceId, String moduleId, IotHubClientProtocol protocol, AuthenticationType authenticationType, ClientType clientType, String publicKeyCert, String privateKey, String x509Thumbprint)
    {
