...
public class GetTwinModuleThingsRunner extends GetTwinTests
{
    static Collection<BaseDevice> identities;



    public GetTwinModuleThingsRunner(String deviceId, String moduleId, IotHubClientProtocol protocol, AuthenticationType authenticationType, ClientType clientType, String publicKeyCert, String privateKey, String x509Thumbprint)
    {
